...
public class UserInfoDAO {
	...
	public boolean insertUserInfo(UserInfo userInfo) {
		...
		Object[] values = new Object[] { userInfo.getUsername(),
				userInfo.getPassword(), userInfo.getSex(), userInfo.getMajor(),
				userInfo.getIntro() };
	 ...
	 */
	public List<UserInfo> selectUserInfo(String username, String sex,
			String major) {
	...
	// 做更新用户信息之前先进行搜索一次的方法通过username查询的唯一一条数据
